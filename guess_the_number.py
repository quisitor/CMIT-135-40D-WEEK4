...
Purpose
-------
The computer chooses a random number between 0 and 100 and the user has to guess
...
if __name__ == '__main__':
    ...
    guessed_input = input('The computer has chosen a number at random between 0 and 100.\n '
